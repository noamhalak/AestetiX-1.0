...
var heIL = require('antd/locale/he_IL');
var jsxRuntime = require('react/jsx-runtime');
var React3 = require('react');

function _interopDefault (e) { return e && e.__esModule ? e : { default: e }; }

var heIL__default = /*#__PURE__*/_interopDefault(heIL);
...
var AestetiXProvider = ({
  children,
  direction = "rtl",
  locale = heIL__default.default
}) => {
  return /* @__PURE__ */ jsxRuntime.jsx(antd.ConfigProvider, { theme: aesthetixTheme, direction, locale, children });
};
...
var Button = React3__default.default.forwardRef(
  (props, ref) => /* @__PURE__ */ jsxRuntime.jsx(antd.Button, { ref, ...props })
);
Button.displayName = "Button";
var Input = React3__default.default.forwardRef(
  ({ size = "middle", status = "", ...rest }, ref) => {
    return /* @__PURE__ */ jsxRuntime.jsx(antd.Input, { ref, size, status, ...rest });
  }
);
Input.displayName = "Input";
var InputPassword = antd.Input.Password;
var InputSearch = antd.Input.Search;
var TextArea = antd.Input.TextArea;
function Select({ size = "middle", status = "", variant = "outlined", ...rest }) {
  return /* @__PURE__ */ jsxRuntime.jsx(antd.Select, { size, status, variant, ...rest });
}
...
var ModalInformation = ({
  ...
  antd.Modal,
  {
    ...
    onOk,
    onCancel,
    children: description && /* @__PURE__ */ jsxRuntime.jsx("p", { style: { margin: 0 }, children: description })
  }
);
...
var Modal = ({ ...props }) => /* @__PURE__ */ jsxRuntime.jsx(antd.Modal, { ...props });
Modal.confirm = antd.Modal.confirm;
Modal.info = antd.Modal.info;
Modal.success = antd.Modal.success;
Modal.warning = antd.Modal.warning;
Modal.error = antd.Modal.error;
Modal.destroyAll = antd.Modal.destroyAll;
var Tag = (props) => /* @__PURE__ */ jsxRuntime.jsx(antd.Tag, { ...props });
Tag.CheckableTag = antd.Tag.CheckableTag;
var TagStatus = ({ status, text }) => /* @__PURE__ */ jsxRuntime.jsxs(antd.Tag, { color: status, children: [
  status === "success" && "\u2713 ",
  status === "error" && "\u2715 ",
  status === "warning" && "\u26A0 ",
  text
] });
var AvatarGroup = antd.Avatar.Group;
var BadgeRibbon = antd.Badge.Ribbon;
var MenuTopNavigation = (props) => /* @__PURE__ */ jsxRuntime.jsx(antd.Menu, { mode: "horizontal", ...props });
...
var RadioGroupButtons = ({
  btnStyle = "outline",
  ...props
}) => /* @__PURE__ */ jsxRuntime.jsx(RadioGroup, { optionType: "button", buttonStyle: btnStyle, ...props });
var EMPTY_IMAGE_DEFAULT = antd.Empty.PRESENTED_IMAGE_DEFAULT;
var EMPTY_IMAGE_SIMPLE = antd.Empty.PRESENTED_IMAGE_SIMPLE;
var SkeletonAvatar = antd.Skeleton.Avatar;
var SkeletonButton = antd.Skeleton.Button;
var SkeletonInput = antd.Skeleton.Input;
var SkeletonImage = antd.Skeleton.Image;
var SkeletonNode = antd.Skeleton.Node;
var { Title, Text, Link, Paragraph } = antd.Typography;
var sizeMap = {
  xs: 12,
  sm: 16,
  md: 20,
...
function LoginForm({
  ...
  const [email, setEmail] = React3__default.default.useState("");
  const [password, setPassword] = React3__default.default.useState("");
  const [rememberMe, setRememberMe] = React3__default.default.useState(false);
  const [showPassword, setShowPassword] = React3__default.default.useState(false);
  const [state, setState] = React3__default.default.useState(externalState ?? "idle");
  const [attempts, setAttempts] = React3__default.default.useState(0);
  ...
  if (state === "error-locked") {
    return /* @__PURE__ */ jsxRuntime.jsx(LoginCard, { children: /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", gap: "16px", padding: "8px 0" }, children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(antd.Alert, { type: "error", message: "\u05D9\u05E9 \u05DC\u05D0\u05E4\u05E1 \u05E1\u05D9\u05E1\u05DE\u05D4 \u05D0\u05D5 \u05DC\u05E4\u05E0\u05D5\u05EA \u05DC\u05EA\u05DE\u05D9\u05DB\u05D4", showIcon: true }),
      /* @__PURE__ */ jsxRuntime.jsx(Button, { type: "default", block: true, onClick: () => {
        setState("forgot");
        setAttempts(0);
      }, children: "\u05D0\u05E4\u05E1 \u05E1\u05D9\u05E1\u05DE\u05D4" }),
  ...
  if (state === "success") {
    return /* @__PURE__ */ jsxRuntime.jsx(LoginCard, { children: /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", gap: "16px", padding: "16px 0" }, children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(antd.Spin, { size: "small" })
    ] }) });
  }
  return /* @__PURE__ */ jsxRuntime.jsxs(LoginCard, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(antd.Divider, { plain: true, children: "\u05D0\u05D5" }),
...
function ForgotForm({ onBack }) {
  const [email, setEmail] = React3__default.default.useState("");
  const [sent, setSent] = React3__default.default.useState(false);
  const [loading, setLoading] = React3__default.default.useState(false);
  const [emailError, setEmailError] = React3__default.default.useState("");
  ...
  if (sent) {
    return /* @__PURE__ */ jsxRuntime.jsx(LoginCard, { children: /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", gap: "16px", padding: "8px 0" }, children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(Button, { type: "primary", block: true, onClick: onBack, children: "\u05D7\u05D6\u05D5\u05E8 \u05DC\u05D4\u05EA\u05D7\u05D1\u05E8\u05D5\u05EA" }),
...
function LoginPage({ onSuccess, logoSrc, appName, initialState }) {
  const [view, setView] = React3__default.default.useState("login");
  const [loginState, setLoginState] = React3__default.default.useState(initialState ?? "idle");
  return /* @__PURE__ */ jsxRuntime.jsx(
    "div",
    {
      style: {
...
function ForgotSentPreview() {
  const [, setSent] = React3__default.default.useState(false);
  return /* @__PURE__ */ jsxRuntime.jsx(LoginCard, { children: /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", gap: "16px", padding: "8px 0" }, children: [
    /* @__PURE__ */ jsxRuntime.jsx(MailIcon, {}),
    /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { textAlign: "center" }, children: [
      /* @__PURE__ */ jsxRuntime.jsx("div", { style: { fontSize: "18px", fontWeight: 700, color: "rgba(0,0,0,0.88)", lineHeight: "26px" }, children: "\u05D1\u05D3\u05D5\u05E7 \u05D0\u05EA \u05D4\u05D0\u05D9\u05DE\u05D9\u05D9\u05DC" }),
    ...
    /* @__PURE__ */ jsxRuntime.jsx(antd.Alert, { type: "info", message: "\u05D4\u05E7\u05D9\u05E9\u05D5\u05E8 \u05D1\u05EA\u05D5\u05E7\u05E3 \u05DC-30 \u05D3\u05E7\u05D5\u05EA", showIcon: true }),
    /* @__PURE__ */ jsxRuntime.jsx(Button, { type: "primary", block: true, children: "\u05D7\u05D6\u05D5\u05E8 \u05DC\u05D4\u05EA\u05D7\u05D1\u05E8\u05D5\u05EA" }),
    /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { fontSize: "14px", color: "rgba(0,0,0,0.45)" }, children: [
      "\u05DC\u05D0 \u05E7\u05D9\u05D1\u05DC\u05EA? ",
...
exports.AestetiXProvider = AestetiXProvider;
...
exports.Title = Title;
exports.aesthetixTheme = aesthetixTheme;
